...
public class EmailService {
    ...
    public void sendQuoteNotification(com.secogroupe.app.dto.QuoteRequestDto dto) {
        ...
        try {
            ...
            helper.setFrom(fromAddress);
            helper.setTo(fromAddress); // notification interne → hr@secogroupe.com
            helper.setReplyTo(dto.getEmail());
            helper.setSubject("Nouvelle demande de devis — " + dto.getFirstName() + " " + dto.getLastName());
            ...
            throw new RuntimeException("Échec de l'envoi de la notification de devis : " + e.getMessage(), e);
        }
    }
    ...
    public void sendQuoteConfirmation(com.secogroupe.app.dto.QuoteRequestDto dto) {
        ...
        try {
            ...
            helper.setSubject("We received your quote request — Secogroupe");
            ...
            throw new RuntimeException("Échec de l'envoi de la confirmation de devis : " + e.getMessage(), e);
        }
    }
}
